...
- Tool name: `cliproxyapi-cli`
- Language / distribution: Go binary + npm wrapper
- Source: `cmd/` and `internal/`; tests: colocated `*_test.go`; Skill: `skills/cliproxyapi-cli/SKILL.md`
- Local checks: `go test -race ./... && go vet ./... && golangci-lint run ./...`
